...
export const set_logging: () => [number, number];
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h184807c7325aee1f: (a: number, b: number) => void;
